...
const yourBearerToken = "a2695507-b954-435d-b99e-a5f0f0c32078";
const config = {
...
app.post("/post-secret", async (req, res) => {
  ...
  const newBody = {'secret':req.body.secret,'score':req.body.score};

  try {
    const response = await axios.post(API_URL + '/secrets/' ,newBody, config);
...
app.post("/put-secret", async (req, res) => {
  const searchId = int(req.body.id);
